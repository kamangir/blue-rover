...
|   |
| --- |
| [`blue-rover`](#) [![image](https://github.com/waveshareteam/ugv_rpi/raw/main/media/UGV-Rover-details-23.jpg)](#) starting off on a [UGV Beast PI ROS2](https://www.waveshare.com/wiki/UGV_Beast_PI_ROS2)... |
...
built by 🌀 [`blue_options-4.223.1`](https://github.com/kamangir/awesome-bash-cli), based on 🐬 [`blue_rover-4.13.1`](https://github.com/kamangir/blue-rover).
